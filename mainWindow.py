...
def mainWindowAppear():
    ...
    column = [sg.Column(layout=productLayout,scrollable=True,vertical_scroll_only=True,element_justification='left')]
    windowLayout = [[sg.Text('Month',background_color='orange'),sg.Text('Customer name',background_color='orange')
               ...
               column]
    return sg.Window(title="Sainsburys Loyalty Rewards", layout = windowLayout, size=(500,300)).read()
